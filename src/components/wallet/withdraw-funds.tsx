...
import { withdrawFunds } from "@/lib/wallet/actions"
...
export function WithdrawFunds({ wallet }: WithdrawFundsProps) {
  ...
  async function onSubmit(data: WithdrawFormValues) {
    ...
    try {
      // Call the server action to create the withdrawal request
    ...
    <div className="grid gap-6 md:grid-cols-2">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Withdraw funds from your wallet to your cryptocurrency address
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              {insufficientFunds && (
                <Alert variant="destructive" className="mb-4">
                  ...
                  <AlertDescription>
                    Your withdrawal amount exceeds your available balance.
                  </AlertDescription>
                </Alert>
              )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Enter the address where you want to receive funds
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="rounded-lg border p-4 space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm">
              <li><span className="font-medium">Platform fee:</span> 1% of withdrawal amount</li>
          ...
          <div className="rounded-lg border p-4 space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm">
              ...
              <li>All withdrawals are subject to KYC verification</li>
            </ul>
          </div>
        </CardContent>
        <CardFooter>
