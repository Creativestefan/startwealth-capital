...
export function PlanCard({ plan, onUpdate }: PlanCardProps) {
  ...
  async function handleDelete() {
    try {
      setIsDeleting(true)
      await deleteGreenEnergyPlan(plan.id)
      toast.success("Green energy plan deleted successfully")
      onUpdate()
          ...
          <CardTitle className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
                ...
                <DialogContent>
                  <DialogTitle>Edit Green Energy Plan</DialogTitle>
              ...
              <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
                ...
                <DialogContent>
                  <DialogTitle>Delete Green Energy Plan</DialogTitle>
                  <div className="flex flex-col items-center justify-center gap-4 py-8">
                    ...
                    <div className="text-center">
                      <DialogDescription>
                        Are you sure you want to delete this green energy plan?
                      </DialogDescription>
