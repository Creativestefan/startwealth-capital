...
import { deleteMarketPlan } from "@/lib/market/actions/plans"
...
export function PlanCard({ plan, onUpdate }: PlanCardProps) {
  ...
  async function handleDelete() {
    try {
      setIsDeleting(true)
      await deleteMarketPlan(plan.id)
      toast.success("Market plan deleted successfully")
      onUpdate()
          ...
          <CardTitle className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
                ...
                <DialogContent>
                  <DialogTitle>Edit Market Plan</DialogTitle>
                  <CreatePlanForm
                    plan={plan}
                    onSuccess={() => {
              ...
              <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
                ...
                <DialogContent>
                  <DialogTitle>Delete Market Plan</DialogTitle>
                  <div className="flex flex-col items-center justify-center gap-4 py-8">
                    ...
                    <div className="text-center">
                      <DialogDescription>
                        Are you sure you want to delete this market plan?
                      </DialogDescription>
