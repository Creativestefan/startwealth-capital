...
export function AnalyticsCharts({ monthlyData, roiTrends }: AnalyticsChartsProps) {
  ...
  const monthlyTrendPercentage = lastTwoMonths.length === 2
    ? ((lastTwoMonths[1].equipmentSales - lastTwoMonths[0].equipmentSales) / lastTwoMonths[0].equipmentSales * 100).toFixed(1)
    : 0
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Monthly Equipment Sales</CardTitle>
        ...
        <CardContent>
          <ChartContainer config={monthlyChartConfig}>
            <BarChart accessibilityLayer data={monthlyData}>
              ...
              <Bar dataKey="equipmentSales" fill="var(--color-equipmentSales)" radius={4} />
            </BarChart>
          </ChartContainer>
        </CardContent>
